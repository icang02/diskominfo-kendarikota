...
@if ($paginator->hasPages())
  <nav class="d-flex flex-column justify-items-center justify-content-center">
    <div class="mx-auto" style="cursor: default;">
      <div class="flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between" style="margin-top: -30px;">
              ...
              @foreach ($element as $page => $url)
                @if ($page == $paginator->currentPage())
                  <li wire:key="paginator-{{ $paginator->getPageName() }}-page-{{ $page }}"
                    ...
                    <span class="page-link text-light" style="background-color: #1976d1;">{{ $page }}</span>
                  </li>
                @else
